...
class NER_model:
    ...
    def predict(self, sents):
        ...
        Returns a dictionary consisting of a list of sentences and a list of mentions, where for each mention AT LEAST
        (it may give additional information) the following information is given:
...
class Flair(NER_model):
    def __init__(self, parameters=None):
        ...
        self.model = SequenceTagger.load("/raid/liuxiao/checkpoints/flair/ner-english-notonotes-fast.bin")
